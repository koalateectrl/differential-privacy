...
def main(unused_argv):
	...
	agg_preds = tf.zeros(shape = (X_test.shape[0], FLAGS.depth), dtype=tf.dtypes.float32, name=None)

	for teacher_id in range(FLAGS.nb_teachers):
		checkpoint_path = FLAGS.train_dir + '/' + 'mnist' + '_' + str(FLAGS.nb_teachers) + '_teachers_' + str(teacher_id) + ".ckpt"
